...
<body>
	<nav class="navbar navbar-expand-sm navbar-inverse">
	    <div class="container-fluid ls">
	      ...
	      <ul class="nav navbar-nav navbar-right">
	        <li class="nav-item"><a class="nav-link" href="" style="color: white;">Customers</a></li>
	        <li class="nav-item"><a class="nav-link" href="http://localhost/advweb/project/admin/messages.php">Messages</a></li>
    ...
    <div>
		...
		<table class="table table-ts">
			...
			<?php
					$stmt = "SELECT * FROM ts_customer_details";
					...
					<tr class="">
					 	...
					 	<td><?php echo $data["fld_gender"]; ?></td>
