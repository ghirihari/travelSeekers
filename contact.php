...
<nav class="navbar navbar-expand-sm navbar-inverse">
	    <div class="container-fluid">
	      ...
	      <ul class="nav navbar-nav navbar-right">
	        ...
	        <li class="nav-item"><a class="nav-link" href="http://localhost/advweb/project/destination.php"><?php echo $data['text_destination'] ?></a></li>
	        <li class="nav-item"><a class="nav-link" href="http://localhost/advweb/project/blog.php"><?php echo $data['text_blog'] ?></a></li>
	        <li class="nav-item"><a class="nav-link" href="http://localhost/advweb/project/contact.php" style="color: white;"><?php echo $data['text_contact'] ?></a></li>
